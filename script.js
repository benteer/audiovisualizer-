...
$("#audio").on("canplaythrough", function(e){
    ...
    $("#duration").text("Duration: "+ yDisplay + "" + moDisplay + "" + dDisplay + "" + hDisplay + "" + mDisplay + "" + sDisplay);
...
class Audio {
  ...
  init() {
    ...
    document.getElementById('file').addEventListener('change', function (e) {
      ...
      var t = e.target.files[0].name.replace(/\.[^/.]+$/, "");
      t = t.replace("-", " ");
      t = t.replace("_", " ");
      t = t.replace("+", " ");
